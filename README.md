# Avenue Supermarts (DMart) — Equity Research Report & Financial Valuation Model.
...
- Debt-to-equity ratio nearly doubled in FY26 (18.6%) versus FY25 (11.6%) — a notable leverage shift in the latest year
...
Restates the income statement and balance sheet as percentages of revenue and total assets respectively, isolating genuine structural shifts in cost and capital structure from pure scale growth.
...
Full standalone balance sheet build — assets, liabilities, and equity — with an explicit "Balanced" check confirming the statement ties out every year, tracking how the balance sheet has scaled alongside store expansion.
...
- Cash & bank balances actually declined in FY26 despite the business growing — worth cross-referencing against the Cash Flow Statement
